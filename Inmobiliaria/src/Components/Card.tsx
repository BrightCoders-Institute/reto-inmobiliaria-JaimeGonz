  ...
  return (
    <View style={[styles.container, darkMode.backgroundColor]}>
      <View style={[styles.imageContainer]}>
        <Image style={styles.image} source={{uri: property.ImgURL}} />
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.firstSectionInfo}>
          <Icon
            ...
            style={styles.right}
          />
          <Text style={[styles.textAddress, {color: '#808181'}]}>
            {property.Address}
          </Text>
        </View>
        <View style={styles.secondSectionInfo}>
          <Icon name="bed" size={20} color="#808181" />
          <Text style={[styles.textQuantity, styles.left, textGrayMode]}>
            {property.Rooms}
          </Text>
          ...
          <Text style={[styles.textQuantity, styles.left, textGrayMode]}>
            {property.Area} ft&sup2;
          </Text>
        </View>
        <View style={styles.thirdSectionInfo}>
          <Text style={[styles.title, darkMode.color]}>
            ${property.MontlyRental}/m
          </Text>
